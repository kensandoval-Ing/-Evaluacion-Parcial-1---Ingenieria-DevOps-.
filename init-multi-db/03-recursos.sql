...
CREATE TABLE recursos_fisicos (
    ...
    CONSTRAINT fk_recursos_isbn FOREIGN KEY (isbn) REFERENCES libros_proyeccion(isbn),
...
CREATE TABLE historial_eventos_recursos_fisicos (
    ...
    CONSTRAINT fk_historial_usuario FOREIGN KEY (usuario_email) REFERENCES usuarios_proyeccion(email),
    CONSTRAINT fk_historial_recurso FOREIGN KEY (recurso_id) REFERENCES recursos_fisicos(id)
) ENGINE=InnoDB;
...
CREATE TABLE mantenimiento_recursos (
    ...
    CONSTRAINT fk_mantenimiento_recurso FOREIGN KEY (recurso_id) REFERENCES recursos_fisicos(id)
) ENGINE=InnoDB;
